package co.com.sofka.racehorse.infra.repository;
...
import co.com.sofka.racehorse.infra.generic.EventSerializer;
...
public class MongoEventStoreRepository implements EventStoreRepository {
    ...
    @Override
    public List<DomainEvent> getEventsBy(String aggregateName, GameId aggregateRootId) {
    ...
    @Override
    public void saveEvent(String aggregateName, GameId aggregateRootId, StoredEvent storedEvent) {
